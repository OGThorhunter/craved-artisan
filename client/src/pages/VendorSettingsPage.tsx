      ...
      <div className="py-8 bg-white min-h-screen">
        <div className="container-responsive">
          ...
          <DashboardHeader 
            ...
            description="Manage your store profile, branding, and business configuration"
          />
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-600">Currently viewing: <span className="text-green-600 font-medium">Store Configuration</span></p>
              </div>
