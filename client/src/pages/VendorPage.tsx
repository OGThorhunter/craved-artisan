...
Every loaf is hand-shaped, every ingredient carefully sourced, and every customer treated like family.`,
    ...
    const mockProducts: Product[] = [
      ...
      },
      {
        ...
        price: 10.00,
        category: 'Bread',
        tags: ['whole grain', 'healthy', 'nutritious'],
        image: '/images/products/whole-wheat-sourdough.jpg',
        inStock: true,
        featured: false,
        rating: 4.7,
        reviewCount: 67,
      ...
      },
      {
        ...
        description: 'Buttery croissants filled with dark chocolate. Perfect with coffee.',
        price: 8.50,
        category: 'Pastries',
        tags: ['chocolate', 'buttery', 'french'],
        image: '/images/products/chocolate-croissants.jpg',
        inStock: true,
        featured: false,
        rating: 4.9,
        reviewCount: 45,
      ...
      },
      {
        ...
        description: 'Rustic fruit galette with seasonal berries and flaky crust.',
        price: 14.00,
        category: 'Pastries',
        tags: ['seasonal', 'fruit', 'rustic'],
        image: '/images/products/fruit-galette.jpg',
        inStock: true,
        featured: false,
        rating: 4.6,
        reviewCount: 23,
      ...
      },
      {
        ...
        description: 'Classic French baguette with crisp crust and airy interior.',
        price: 7.50,
        category: 'Bread',
        tags: ['french', 'classic', 'crusty'],
    ...
    const mockReviews: Review[] = [
      ...
      },
      {
        ...
        userName: 'Michael R.',
        rating: 5,
        title: 'Amazing cinnamon rolls',
        comment: 'These cinnamon rolls are to die for! Perfectly sweet and the cream cheese frosting is divine. Worth every penny.',
        date: '2024-01-16',
        helpful: 8,
        productId: '1',
      ...
      },
      {
        ...
        comment: 'Love the whole wheat sourdough. The quality is excellent and the staff is always so friendly. Highly recommend!',
        date: '2024-01-14',
        helpful: 5,
        productId: '3',
        productName: 'Whole Wheat Sourdough'
      }
    ];
