        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">Manage your shop and track your success</p>
            </div>
                    ...
                    <div key={i} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">Handcrafted Necklace</p>
                        </div>
                      </div>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <div className="space-y-3">
                ...
                <button className="w-full btn-secondary">Update Profile</button>
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-900">Product viewed 15 times</p>
