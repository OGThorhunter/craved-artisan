  ...
  return (
    <section className="bg-brand-cream text-brand-charcoal">
      ...
      <div className="max-w-6xl mx-auto py-16 px-6">
        <h2 className="responsive-heading mb-6">Why Customers Love Craved Artisan</h2>
      ...
      <div className="bg-gray-50 py-12 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="responsive-subheading mb-4">What You Can Discover</h2>
      ...
      <div className="max-w-4xl mx-auto py-16 px-6">
        <h2 className="responsive-subheading mb-6 text-center">How Shopping Works</h2>
      ...
      <div className="bg-brand-cream py-12 px-6 text-center">
        <h2 className="responsive-subheading mb-4">What Customers Are Saying</h2>
      ...
      <div className="max-w-5xl mx-auto py-16 px-6">
        <h2 className="responsive-subheading mb-4 text-center">What the Marketplace Looks Like</h2>
        <div className="bg-white rounded-lg shadow-lg p-8">
          <div className="bg-gray-100 rounded-lg p-6 text-center">
            <ShoppingBag className="w-16 h-16 mx-auto text-gray-400 mb-4" />
            <p className="text-gray-600">Local Marketplace Preview</p>
            <p className="responsive-text text-gray-500 mt-2">Browse products from local vendors, read reviews, and place orders</p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            <details className="bg-white p-4 rounded shadow">
              ...
              <p className="mt-2 responsive-text text-gray-600">All vendors must follow local food safety laws and we verify their credentials.</p>
            </details>
            <details className="bg-white p-4 rounded shadow">
              <summary className="cursor-pointer font-medium">What are the delivery options?</summary>
              <p className="mt-2 responsive-text text-gray-600">Local pickup, vendor delivery, or use our network of drop-off locations.</p>
            </details>
            <details className="bg-white p-4 rounded shadow">
              <summary className="cursor-pointer font-medium">Can I return products?</summary>
              <p className="mt-2 responsive-text text-gray-600">Return policies vary by vendor, but most offer satisfaction guarantees.</p>
            </details>
            <details className="bg-white p-4 rounded shadow">
              <summary className="cursor-pointer font-medium">How do I pay for orders?</summary>
              <p className="mt-2 responsive-text text-gray-600">Secure payments via credit card, with funds held until you receive your order.</p>
            </details>
          </div>
        </div>
      </div>
      ...
      <div className="text-center py-12 px-6">
        <p className="responsive-text text-gray-600 mb-4">Interested in selling instead?</p>
